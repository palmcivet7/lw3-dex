...
export default function Home() {
  ...
  */
  ...
  return (
    <div>
      <Head>
        <title>Palmcivet CD Exchange</title>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>
            Welcome to Palmcivet Crypto Devs Exchange
          </h1>
          <div className={styles.description}>
            Exchange Ethereum &#60;&#62; Palmcivet Crypto Dev Tokens
          </div>
          <div>
            <button
        ...
        <div>
          <img className={styles.image} src="./palmcivet-stencil.png" />
        </div>
      </div>

      <footer className={styles.footer}>palmcivet.eth</footer>
    </div>
  );
}
